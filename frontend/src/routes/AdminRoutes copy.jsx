...
export default function AdminRoutes() {
  return (
    <Route
      path="/admin"
      element={
        <ProtectedRoute allowedRoles={[1, 0, 5 /* Admin + Support roles */]}>
          <GlobalLayout />
        </ProtectedRoute>
      }
    >
      ...
      <Route path="hub">
        ...
        <Route path="edu">
          ...
          <Route path="classes" element={<SubjectsList />} />
          <Route path="content" element={<ContentOverview />} />
          <Route path="community" element={<ContentOverview />} />
          <Route path="analytics" element={<AnalyticsDashboard />} />
          <Route path="blog" element={<PublishBlogPost />} />
          <Route path="reports" element={<Navigate to="/admin/reports/generate" replace />} />
          <Route index element={<Navigate to="/admin/hub/edu/dashboard" replace />} />
        </Route>
      </Route>
      ...
      <Route path="academics">
        ...
        <Route path="scans" element={<ScansOverview />} />
      </Route>
      ...
      {/* Philosophy */}
      <Route path="philosophy" element={<PhilosophyOverview />} />
