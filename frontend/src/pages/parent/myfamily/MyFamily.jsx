...
import {
  PlusOutlined, ReloadOutlined, UserOutlined, IdcardOutlined, BookOutlined, HomeOutlined, ArrowLeftOutlined
...
/* Optional: unify background with other parent screens */
  ...
  return (
    <GradientShell backgroundImage={globalBg}>
      <div className="w-full min-h-[100dvh] flex justify-center">
        {/* Single-column layout inside phone mockup; footer handled by ParentTabSpacer + BottomTabBar */}
