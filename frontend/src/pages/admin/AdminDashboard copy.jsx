...
export default function AdminDashboard() {
  ...
  const features = [
    // --- Hub shortcuts ---
    {
      ...
      desc: "Home • Customers • Analytics • Help",
      to: "/admin/hub/support/dashboard",
    },
    {
      icon: <AppstoreOutlined style={{ fontSize: 28, color: "#1677ff" }} />,
      title: "EduPlatform",
      desc: "Analytics • Dashboard • Blog/News",
      to: "/admin/hub/edu/dashboard",
    },
    // --- Existing shortcuts ---
    {
    ...
    // Optional: direct link to Blog/News composer
    {
      icon: <ReadOutlined style={{ fontSize: 28, color: "#1677ff" }} />,
      title: "Publish Blog / News",
      desc: "Create announcements for EduPlatform.",
      to: "/admin/hub/edu/blog",
    },
  ];
  ...
  return (
    <div className="p-6 max-w-screen-xl mx-auto">
      ...
      {/* Hubs */}
      <section className="mb-10">
        <h2 className="text-xl font-semibold mb-4">Hubs</h2>
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12} md={8} lg={6} style={{ display: "flex" }}>
            <Card
              {...featureCardProps}
              onClick={() => navigate("/admin/hub/support/dashboard")}
            >
              <div className="w-full flex flex-col items-center text-center gap-2">
                <CustomerServiceOutlined style={{ fontSize: 28, color: "#1677ff" }} />
                <p className="font-semibold mt-1">Support Central</p>
                <p className="text-gray-500 text-sm">Home • Customers • Analytics • Help</p>
              </div>
            </Card>
          </Col>
          ...
          <Col xs={24} sm={12} md={8} lg={6} style={{ display: "flex" }}>
            <Card
              {...featureCardProps}
              onClick={() => navigate("/admin/hub/edu/dashboard")}
            >
              <div className="w-full flex flex-col items-center text-center gap-2">
                <AppstoreOutlined style={{ fontSize: 28, color: "#1677ff" }} />
                <p className="font-semibold mt-1">EduPlatform</p>
                <p className="text-gray-500 text-sm">Analytics • Dashboard • Blog/News</p>
              </div>
            </Card>
          </Col>
        </Row>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            className="shadow-sm"
            onClick={() => navigate("/admin/hub/edu/blog")}
          >
            Publish Blog / News
          </Button>
        </div>
