...
/** NOTE: replace these with provided asset files once the client shares them */
const IMGS = {
  homework:
...
const FALLBACK = "https://via.placeholder.com/800x320.png?text=Kibundo";

/* ------------------------ tiny helpers for the streak chip ------------------------ */
const STREAK_KEY = "kib_streak_v1";
